...
<%-- 					href="<%=ORSView.CLIENT_LIST_CTL%>"> Client List</b></a> | <a --%>
					...
					href="<%=ORSView.STAFF_LIST_CTL%>">Staff List</b></a> --%>
					 ...
					 <%-- <a href="<%=ORSView.PHYSICIAN_CTL%>">Add Physician</b></a> | <a
					href="<%=ORSView.PHYSICIAN_LIST_CTL%>">Physician List</b></a>|  --%>
					
					 <a href="<%=ORSView.FAVOURITE_CTL%>">Add Favourite</b></a> | <a
					href="<%=ORSView.FAVOURITE_LIST_CTL%>">Favourite List</b></a>| 
