...
/**
 * Physician List functionality Controller. Performs operation for list, search
 * and delete operations of Physician
 * 
 * @author priya Mandal;
 */
...
public class PhysicianListCtl extends BaseCtl {
	...
	private static Logger log = Logger.getLogger(PhysicianListCtl.class);
	...
	/**
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			log.debug("PhysicianListCtl doGet Start");
			List list = null;
			List nextList = null;
...
//		        get the selected checkbox ids array for delete list
			...
			log.debug("PhysicianListCtl doGet End");
		}
	...
	/**
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)
				throws ServletException, IOException {
			log.debug("PhysicianListCtl doPost Start");
